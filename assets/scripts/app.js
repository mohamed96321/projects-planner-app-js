...
class Tooltip extends Component {
  ...
  create() {
    ...
    const tooltipTemplete = document.getElementById('tooltip');
    const tooltipBody = document.importNode(
      tooltipTemplete.content, 
      true
    );
    ...
    // tooltipElement.addEventListener('click', this.detach.bind(this)); // if not using arrow function
...
class App {
  static init() {
    ...
    const timerId = setTimeout(this.startAnalytics, 3000); // number in milliseconds
